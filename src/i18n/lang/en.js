export default {
  ...
  plant: {
    ...
    genMon: 'Generation this month',
    earnMon: 'Earnings this month',
    genYear: 'Generation this year',
    earnYear: 'Earnings this year',
    genTot: 'Generation total',
    earnTot: 'Earnings total',
    plantsList: 'Plants list',
    equipQua: 'Equipment quantity',
    InsCap: 'Installed capacity',
    genToday: 'Generation today',
